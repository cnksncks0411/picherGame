...
- **Web dev server**: `npm start` (serves release wasm; `WIE_WASM_DEV=1` for fast Rust rebuilds)
...
- `wie-web`: Rust/WebAssembly core bindings (`src/rust`) and React/Vite web frontend (`src/web`)
